...
<section class="portlet" id="portlet_${portlet_id}">
	<#if portlet_display.isPortletDecorate() && !portlet_display.isStateMax() && portlet_display.getPortletConfigurationIconMenu()?? && portlet_display.getPortletToolbar()??>
		...
		<#if permissionChecker.isCompanyAdmin() && (portlet_configuration_icons?has_content || portlet_title_menus?has_content)>
	...
	<div class="${portlet_content_css_class}">
        ...
        <#if permissionChecker.isCompanyAdmin() || !stringUtil.equals(portlet_display.getPortletDecoratorId(), "barebone")>
